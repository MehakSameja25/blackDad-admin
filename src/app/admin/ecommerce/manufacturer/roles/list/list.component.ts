...
import { RoleList } from 'src/app/admin/model/member.model';
...
export class ListComponent implements OnInit {
  ...
  constructor(
    ...
    private manufecServie: ManufacturersService,
  ...
  open(content: ElementRef, id: string | null) {
    ...
    // }
    // this.manufecServie.list().subscribe((res : any) => {
  ...
  deleteRole(id: string | null) {
    ...
    //   this.roleService.assign(this.allChangeRoles).subscribe((res) => {
  ...
  toEdit(id: string | null) {
    this.router.navigate([`/admin/manufecturer/roles/update/${id}`]);
  }
}
